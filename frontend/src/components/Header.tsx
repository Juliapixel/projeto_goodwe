...
export default function Header() {
    return (
        <header className="fixed from-shis-950 to-transparent bg-gradient-to-b top-0 left-0 z-10 md:p-8 w-screen">
            <div className="flex shadow-md justify-between px-4 md:px-8 w-full h-18 md:h-20 md:rounded-3xl bg-zinc-200 border border-white ">
                ...
                <div className="flex gap-6 my-auto text-black font-medium text-xl">
                    <Link to="/sobre" className="my-auto">
                        Sobre
                    </Link>
                    <Link to="/dados" className="my-auto">
                        Dados
                    </Link>
                    <Link
                        to="/dispositivos"
                        className="rounded-full bg-gradient-to-l to-red-400 from-red-500 py-2 px-6 text-white"
                    >
                        Dispositivos
                    </Link>
                </div>
